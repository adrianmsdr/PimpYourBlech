...
namespace PimpYourBlech_ClassLibrary.Migrations
{
    ...
    [Migration("20260112231020_Payment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PimpYourBlech_ClassLibrary.Entities.DeliveryAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PimpYourBlech_ClassLibrary.Entities.OrderPosition", b =>
                {
            ...
            modelBuilder.Entity("PimpYourBlech_ClassLibrary.Entities.PaymentValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PimpYourBlech_ClassLibrary.Entities.Order", b =>
                {
                    ...
                    b.HasOne("PimpYourBlech_ClassLibrary.Entities.DeliveryAddress", "DeliveryAddress")
                        .WithMany()
                        .HasForeignKey("DeliveryAddressId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PimpYourBlech_ClassLibrary.Entities.PaymentValue", "PaymentValue")
                        .WithMany()
            ...
            modelBuilder.Entity("PimpYourBlech_ClassLibrary.Entities.OrderPosition", b =>
                {
                    b.HasOne("PimpYourBlech_ClassLibrary.Entities.Order", "Order")
                        .WithMany("Items")
