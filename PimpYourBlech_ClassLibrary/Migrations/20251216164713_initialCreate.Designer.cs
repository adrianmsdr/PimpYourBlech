...
namespace PimpYourBlech_ClassLibrary.Migrations
{
    ...
    [Migration("20251216164713_initialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PimpYourBlech_ClassLibrary.Entities.CommunityAnswer", b =>
                {
                    ...
                    b.Property<int?>("CommunityAnswerId")
                        .HasColumnType("integer");

                    b.Property<int?>("CommunityQuestionId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CommunityAnswerId");

                    b.HasIndex("CommunityQuestionId");
            ...
            modelBuilder.Entity("PimpYourBlech_ClassLibrary.Entities.CommunityAnswer", b =>
                {
                    b.HasOne("PimpYourBlech_ClassLibrary.Entities.CommunityAnswer", null)
                        .WithMany("Answers")
                        .HasForeignKey("CommunityAnswerId");

                    b.HasOne("PimpYourBlech_ClassLibrary.Entities.CommunityQuestion", null)
                        .WithMany("Answers")
                        .HasForeignKey("CommunityQuestionId");
                });
