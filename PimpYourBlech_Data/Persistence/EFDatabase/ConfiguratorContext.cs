...
public sealed class ConfiguratorContext : DbContext, IDatabase
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.HasSequence<int>("ArticleNumberSeq").StartsAt(100026).IncrementsBy(1);
...
=====================================================*/
        modelBuilder.Entity<Product>().HasData(
            ...
            new Product
            {
                ProductId = 1, CarId = 1, Name = "Queenstown Felge", ArticleNumber = "0100000", Brand = "Volkswagen",
            ...
            new Product
            {
                ProductId = 2, CarId = 1, Name = "Warmenau Performance Felge", ArticleNumber = "0100001",
            ...
            new Product
            {
                ProductId = 21, CarId = 1, Name = "Pretoria Sport Felge", ArticleNumber = "0100020",
            ...
            new Product
            {
                ProductId = 3, CarId = 1, Name = "GTI 2.0 TFSI Performance Motor", ArticleNumber = "0100002",
            ...
            new Product
            {
                ProductId = 4, CarId = 1, Name = "GTI Clubsport RS Motor", ArticleNumber = "0100003",
            ...
            new Product
            {
                ProductId = 15, CarId = 1, Name = "GTI EcoBoost Hybrid Motor", ArticleNumber = "0100014",
            ...
            new Product
            {
                ProductId = 5, CarId = 1, Name = "IQ.Light LED Matrix Pro", ArticleNumber = "0100004",
            ...
            new Product
            {
                ProductId = 6, CarId = 1, Name = "Dynamic Vision LED Blackline", ArticleNumber = "0100005",
            ...
            new Product
            {
                ProductId = 16, CarId = 1, Name = "NightDrive LED UltraBeam", ArticleNumber = "0100015",
            ...
            new Product
            {
                ProductId = 7, CarId = 1, Name = "Tornadorot", ArticleNumber = "0100006", Brand = "Volkswagen",
                Description = "Kräftige Sportlackierung.", Quantity = 20, Price = 1799.99m, ProductType = ProductType.Lack
            },
            new Product
            {
                ProductId = 8, CarId = 1, Name = "Metallic Weiß Perleffekt", ArticleNumber = "0100007",
                Brand = "Volkswagen", Description = "Eleganter Perlglanz.", Quantity = 20, Price = 1899.99m,
                ProductType = ProductType.Lack
            },
            new Product
            {
                ProductId = 17, CarId = 1, Name = "Deep Black Pearl", ArticleNumber = "0100016", Brand = "Volkswagen",
            ...
            new Product
            {
                ProductId = 22, CarId = 2, Name = "Astana Felge", ArticleNumber = "0100021", Brand = "Volkswagen",
            ...
            new Product
            {
                ProductId = 23, CarId = 2, Name = "Bergamo Sport Felge", ArticleNumber = "0100022", Brand = "Volkswagen",
            ...
            new Product
            {
                ProductId = 24, CarId = 2, Name = "Verona Black Performance Felge", ArticleNumber = "0100023",
            ...
            new Product
            {
                ProductId = 11, CarId = 2, Name = "Polo 1.0 TSI BlueMotion Motor", ArticleNumber = "0100010",
            ...
            new Product
            {
                ProductId = 12, CarId = 2, Name = "Polo 1.5 TSI GT-Line Motor", ArticleNumber = "0100011",
            ...
            new Product
            {
                ProductId = 19, CarId = 2, Name = "Polo 1.2 Hybrid Drive", ArticleNumber = "0100018",
            ...
            new Product
            {
                ProductId = 13, CarId = 2, Name = "Polo LED Comfort Beam", ArticleNumber = "0100012",
            ...
            new Product
            {
                ProductId = 14, CarId = 2, Name = "Polo LED NightVision Plus", ArticleNumber = "0100013",
            ...
            new Product
            {
                ProductId = 20, CarId = 2, Name = "Polo Adaptive Pixel Light", ArticleNumber = "0100019",
            ...
            new Product
            {
                ProductId = 9, CarId = 2, Name = "Crystal Ice Blue Metallic", ArticleNumber = "0100008",
                Brand = "Volkswagen", Description = "Kühle Metallic-Lackierung.", Quantity = 20, Price = 1599.99m,
                ProductType = ProductType.Lack
            },
            new Product
            {
                ProductId = 10, CarId = 2, Name = "Kings Red Velvet", ArticleNumber = "0100009", Brand = "Volkswagen",
                Description = "Edler Rotton mit Tiefenglanz.", Quantity = 20, Price = 1699.99m,
                ProductType = ProductType.Lack
            },
            new Product
            {
                ProductId = 18, CarId = 2, Name = "Urban Grey Metallic", ArticleNumber = "0100017", Brand = "Volkswagen",
